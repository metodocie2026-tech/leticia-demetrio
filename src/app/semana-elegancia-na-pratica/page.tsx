...
function CtaButtonLight({ label, className }: { label: string; className?: string }) {
  return (
    <a
      href="#inscricao"
  ...
  return (
    <>
      ...
      <main className="bg-white">
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-3 lg:gap-14 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="font-heading text-xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-white leading-[1.15] mb-2">
                ...
                <span className="text-primary">elegante e prática</span>{' '}
        ...
        {/* ── Para quem é ──────────────────────────────────────────────── */}
        <section className="py-16 lg:py-24 bg-dark" aria-labelledby="para-quem-titulo">
          <div className="max-w-3xl mx-auto px-4 sm:px-6">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {A.paraQuem.itens.map((item) => (
                ...
                >
                  <CheckCircle size={17} className="text-primary shrink-0 mt-0.5" aria-hidden="true" />
                  <span className="text-white/75 font-body text-sm leading-relaxed">{item}</span>
                </li>
              ))}
            </ul>
          </div>
        ...
        {/* ── Problem bridge ────────────────────────────────────────────── */}
        <section className="py-16 lg:py-24 bg-primary relative overflow-hidden" aria-label="O problema real">
          <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        {/* ── Agenda ───────────────────────────────────────────────────── */}
        <section className="py-16 lg:py-24 bg-white" aria-labelledby="agenda-titulo">
          <div className="max-w-3xl mx-auto px-4 sm:px-6">
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="flex items-center gap-1.5 text-xs text-muted font-body mt-3">
                      <PlayCircle size={12} className="text-primary shrink-0" aria-hidden="true" />
                      {aula.plataforma}
                    </p>
                  </div>
                </li>
        ...
        <section className="py-16 lg:py-24 bg-dark" aria-labelledby="acesso-titulo">
          <div className="max-w-3xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-primary font-body">
        ...
        {/* ── Sobre Letícia ────────────────────────────────────────────── */}
        <section className="py-16 lg:py-24 bg-white" aria-labelledby="sobre-titulo">
          <div className="max-w-3xl mx-auto px-4 sm:px-6">
              ...
              <div>
                ...
                <div className="flex flex-col gap-4">
                  {A.sobre.paragrafos.map((p, i) => (
                    <p key={i} className="text-subtle font-body leading-relaxed text-sm sm:text-base">
                      {p}
                    </p>
                  ))}
                </div>
        ...
        >
          ...
          <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-white/75 font-body mb-10">{A.ctaFinal.subtitulo}</p>
